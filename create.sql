CREATE TABLE TB_CLIENTE (ID BIGINT AUTO_INCREMENT NOT NULL, TXT_EMAIL VARCHAR(50) NOT NULL, TXT_LOGIN VARCHAR(50) NOT NULL, TXT_NOME VARCHAR(255) NOT NULL, TXT_SENHA VARCHAR(20) NOT NULL, TXT_TELEFONE VARCHAR(20) NOT NULL, END_TXT_BAIRRO VARCHAR(50) NOT NULL, END_TXT_CEP VARCHAR(9) NOT NULL, END_TXT_CIDADE VARCHAR(50) NOT NULL, END_TXT_COMPLEMENTO VARCHAR(255), END_TXT_ESTADO VARCHAR(50) NOT NULL, END_TXT_LOGRADOURO VARCHAR(100) NOT NULL, END_INT_NUMERO INTEGER NOT NULL, ID_CARTAO BIGINT, PRIMARY KEY (ID))
...
CREATE TABLE TB_PEDIDO (ID BIGINT AUTO_INCREMENT NOT NULL, DT_PEDIDO DATE NOT NULL, HR_PEDIDO TIME NOT NULL, TXT_STATUS_COMPRA VARCHAR(20) NOT NULL, ID_CLIENTE BIGINT, PRIMARY KEY (ID))
