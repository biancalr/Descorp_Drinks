...
CREATE TABLE TB_PEDIDO (ID BIGINT AUTO_INCREMENT NOT NULL, DT_PEDIDO DATE, HR_PEDIDO TIME, TXT_STATUS_COMPRA VARCHAR(255) NOT NULL, ID_CLIENTE BIGINT, PRIMARY KEY (ID))
